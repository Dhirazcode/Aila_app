...
const Post = ({ post, onPostDelete }) => {  // Added onPostDelete prop
    ...
    const deletePostHandler = async () => {
        try {
            ...
            if (res.data === 'OK') {
                ...
                toast.success('Post deleted successfully'); // Use a static message for simplicity
        ...
        <div className='my-8 w-full max-w-sm mx-auto'>
            ...
            <div className='flex items-center justify-between'>
                <div className='flex items-center gap-3 my-2'>
                    <FaRegHeart onClick={likeOrDisliked} size={'22px'} className='cursor-pointer hover:bg-orange-600' />
